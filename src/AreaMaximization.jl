...
N = 2                # (user-defined) Total number of UAVs 
...
for k in 1: M   # epoch index k∈[1,M]
    ...
    input_problem = Greens_Method.Greens_Problem(updated_MADS) #Creates a new instance of Greens Problem.

    # II. Main optimization function
    global STATIC_output = TDM_STATIC_opt.optimize(STATIC_input, obj_main1, cons_ext, cons_prog, N_iter, r_min, r_max, d_lim, k,  circles_pool)
